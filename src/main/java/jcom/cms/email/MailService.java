...
public class MailService {
    ...
    @Autowired
    private PagesService pagesServices;
  ...
  //  @Autowired
   ...
   // OrdersService ordersService;
    ...
    public String sendSystemMail(String direction, String to, Map<String,String> map){
        ...
        Pages page = pagesServices.getByDirection(direction);
    ...
    public String sendmail(String to, String subject, String body)   {
        Settings settings = settingsService.findFirstByParam("_email_settings");
        ...
        try {
            ...
            log.error("Message send problem: "+e.getMessage());
            return e.getMessage();
        }
    }
