...
import jcom.cms.pojo.Attributes;
import jcom.cms.pojo.AttributesVar;
import jcom.cms.pojo.Config;
...
public class HelpersJson extends  HelpersFile{
    ...
    public static Config getConficData() {
        return conficData;
    }

    public static void setConficData() {
          if(conficData == null){
